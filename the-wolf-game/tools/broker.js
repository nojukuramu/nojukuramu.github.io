 ...
 *
 * Copied verbatim from KaraokeNatin, where the same transport already runs.
 * Nothing in the app knows it exists: the test points window.WG_BROKERS at it,
 * so the end-to-end run needs no public host and works with no egress at all.
 *
